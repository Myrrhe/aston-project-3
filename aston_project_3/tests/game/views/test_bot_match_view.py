...
from apps.game.views import BotMatchViewSet


class TestBotMatchView(TransactionTestCase):
    """The tests for the bot match view."""
    ...
    def setUp(self) -> None:
        ...
        self.user_1 = User.objects.create_user(
            "bot_match_view_1@test.com", "123456"
        )
        self.user_2 = User.objects.create_user(
            "bot_match_view_2@test.com", "123456"
        )
