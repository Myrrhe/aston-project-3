...
urlpatterns = [
    ...
    path(
        "account_created/",
        AccountCreatedViewSet.as_view(),
        name="account-created"
    ),
    path("account/", AccountViewSet.as_view(), name="account"),
    path(
        "delete-account/",
        DeleteAccountViewSet.as_view(),
        name="delete-account"
    ),
    path(
        "account-deleted/",
        AccountDeletedViewSet.as_view(),
        name="account-deleted"
    ),
    path(
        "cookies-policy/",
        CookiesPolicyViewSet.as_view(),
        name="cookies-policy"
    ),
    path(
        "cookies-settings/",
        CookiesSettingsViewSet.as_view(),
        name="cookies-settings"
    ),
    path(
        "add-security-key/",
        AddSecurityKeyViewSet.as_view(),
